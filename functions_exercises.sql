...
SELECT CONCAT(CONCAT(SUBSTR(LOWER(first_name), 1,1), SUBSTR(LOWER(last_name), 1, 4)),'_', 'SUBSTR(birth_date), 6, 10')AS username, first_name, last_name, birth_date FROM employees;
